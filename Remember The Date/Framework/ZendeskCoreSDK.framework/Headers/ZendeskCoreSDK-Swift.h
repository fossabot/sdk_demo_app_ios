...
SWIFT_PROTOCOL("_TtP14ZendeskCoreSDK12ObjCIdentity_")
@protocol ObjCIdentity
@end


SWIFT_CLASS("_TtC14ZendeskCoreSDK13ObjCAnonymous")
@interface ObjCAnonymous : NSObject <ObjCIdentity>
...
SWIFT_CLASS("_TtC14ZendeskCoreSDK7ObjCJwt")
@interface ObjCJwt : NSObject <ObjCIdentity>
...
SWIFT_CLASS("_TtC14ZendeskCoreSDK7Zendesk")
...
@interface Zendesk (SWIFT_EXTENSION(ZendeskCoreSDK))
...
- (void)setIdentity:(id <ObjCIdentity> _Nonnull)newIdentity;
- (id <ObjCIdentity> _Nullable)objCIdentity SWIFT_WARN_UNUSED_RESULT;
@end
