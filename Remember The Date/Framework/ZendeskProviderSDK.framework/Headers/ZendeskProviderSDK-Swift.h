...
+ (void)performRequestWithZendesk:(Zendesk * _Nonnull)zendesk urlRequset:(NSURLRequest * _Nonnull)urlRequset requiresAuth:(BOOL)requiresAuth completionHandler:(void (^ _Nonnull)(NSURLResponse * _Nullable, NSData * _Nullable, NSError * _Nullable))completionHandler;
...
- (nonnull instancetype)initWithZendesk:(Zendesk * _Nonnull)zendesk;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
+ (void)getTicketFormsSettingsWithCallback:(void (^ _Nonnull)(ZDKContactUsSettings * _Nullable))callback;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
///
- (void)markRequestAsRead:(NSString * _Nonnull)requestId;
...
@interface Zendesk (SWIFT_EXTENSION(ZendeskProviderSDK))
